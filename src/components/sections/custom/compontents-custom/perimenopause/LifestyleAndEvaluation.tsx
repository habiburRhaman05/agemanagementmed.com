 ...
 * followed by "how we evaluate" (dark, edge-to-edge — no rounding, wider
 * than the standard contained card). Content-only.
 */
  ...
  return (
    <>
      <Section background="page" spacing="md">
        <Container>
          <Reveal>
            <div className="grid items-center gap-8 lg:grid-cols-[38%_62%] lg:gap-14">
      ...
      <Reveal>
        <div className="grid overflow-hidden bg-ink-950 lg:grid-cols-2">
