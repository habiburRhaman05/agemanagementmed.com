...
export async function GlpMicrodosingFemaleLayout({ treatment }: TreatmentTemplateProps) {
  ...
  return (
    <>
      ...
      <ClosingCTA {...treatment.closingCta} backgroundImage="/specials/hero-34-bg.jpg" textWidth={"620"}  />
    </>
  )
}
