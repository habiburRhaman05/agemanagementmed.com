    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">
          Overview of your practice management
        </p>
      </div>
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <Link
          href="/admin/blog"
          className="inline-flex items-center gap-2 rounded-lg border bg-white px-4 py-2.5 text-sm font-medium text-gray-700 shadow-sm transition-all hover:bg-gray-50"
        >
          Manage Blogs
        </Link>
        <Link
