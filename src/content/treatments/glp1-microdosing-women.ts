...
/**
 * GLP-1 Microdosing - Women. The underlying program (mechanism, diagnostics,
 * candidacy) is identical to the men's protocol - only providers/testimonials
 * differ by gender in the source content - so the body sections below mirror
 * glp1-microdosing-men.ts rather than leaving this page thin. See the Phase 2
 * audit report for the full list of what was restored here vs. invented (none).
 */
